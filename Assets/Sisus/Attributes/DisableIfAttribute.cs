...
namespace Sisus.Attributes
{
	...
	public class DisableIfAttribute : ShowInInspectorAttribute
	{
		[CanBeNull]
		...
		/// <summary>
		/// Show the class member that follows this attribute as disabled (read-only) if the predicate statement is true.
		/// </summary>
		...
		public DisableIfAttribute(string booleanExpression) : base()
		{
		...
		/// <param name="classMemberName"> Name of another class member inside the same class as the class member with this attribute. </param>
		/// <param name="requiredValue"></param>
		public DisableIfAttribute(string classMemberName, Is comparison, object requiredValue) : base()
		{
		...
		/// <param name="classMemberName"> Name of another class member inside the same class as the class member with this attribute. </param>
		/// <param name="requiredValue"></param>
		public DisableIfAttribute(string classMemberName, string comparison, object requiredValue) : base()
		{
			expression = null;
		...
		/// <summary>
		/// Determines whether or not class member that follows attribute should be disabled (read-only) in the inspector at this time.
		/// </summary>
		...
		/// <returns> True if target class member should currently be disabled in the inspector. </returns>
		public bool ShouldDrawDisabled([NotNull]Type containingClassType, [CanBeNull]object containingClassInstance, [CanBeNull]MemberInfo classMember)
		{
			if(evaluator == null)
			{
